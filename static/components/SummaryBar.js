export default {
  ...
  <div class="summary-bar">
    ...
    <div class="summary-item"><span class="summary-label">持仓市值</span><span class="summary-value mono amber">\${{ posValue }}</span></div>
  ...
  computed: {
    pnlClass() { return (this.s.total_pnl || 0) >= 0 ? 'green' : 'red'; },
    posValue() { const v = (this.s.total_value||0) - (this.s.total_cash||0); return (Math.abs(v) < 0.01 ? '0.00' : v.toFixed(2)); }
  },
  methods: {
